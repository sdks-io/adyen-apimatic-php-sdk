...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`CreateOrderResponse`](../../doc/models/create-order-response.md).

## Example Usage

```php
$body = CreateOrderRequestBuilder::init(
    Amount20Builder::init(
        'EUR',
        2500
    )->build(),
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`CancelOrderResponse`](../../doc/models/cancel-order-response.md).
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`BalanceCheckResponse`](../../doc/models/balance-check-response.md).
