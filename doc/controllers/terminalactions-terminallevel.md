...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`ScheduleTerminalActionsResponse`](../../doc/models/schedule-terminal-actions-response.md).

## Example Usage

```php
$body = ScheduleTerminalActionsRequestBuilder::init()
    ->actionDetails(
        InstallAndroidAppDetailsBuilder::init()
...
if ($apiResponse->isSuccess()) {
    echo 'ScheduleTerminalActionsResponse:';
