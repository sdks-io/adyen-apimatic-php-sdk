...
|  --- | --- | --- | --- | --- | --- |
| `accountType` | [`?string(AccountType1)`](../../doc/models/account-type-1.md) | Optional | The type of the bank account. | getAccountType(): ?string | setAccountType(?string accountType): void |
