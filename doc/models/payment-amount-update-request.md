...
|  --- | --- | --- | --- | --- | --- |
| `amount` | [`Amount28`](../../doc/models/amount-28.md) | Required | The updated amount. The `currency` must match the currency used in authorisation. | getAmount(): Amount28 | setAmount(Amount28 amount): void |
