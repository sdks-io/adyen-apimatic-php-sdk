...
|  --- | --- | --- | --- | --- | --- |
| `amount` | [`Amount30`](../../doc/models/amount-30.md) | Required | The amount that you want to capture. The `currency` must match the currency used in authorisation, the `value` must be smaller than or equal to the authorised amount. | getAmount(): Amount30 | setAmount(Amount30 amount): void |
