...
| `shopperInteraction` | [`?string(ShopperInteraction1)`](../../doc/models/shopper-interaction-1.md) | Optional | The sales channel. Required if the merchant account does not have a sales channel. When you provide this field, it overrides the default sales channel set on the merchant account.<br><br>Possible values: **eCommerce**, **pos**, **contAuth**, and **moto**. | getShopperInteraction(): ?string | setShopperInteraction(?string shopperInteraction): void |
...
| `type` | [`string(Type410)`](../../doc/models/type-410.md) | Required | Payment method [variant](https://docs.adyen.com/development-resources/paymentmethodvariant#management-api). | getType(): string | setType(string type): void |
