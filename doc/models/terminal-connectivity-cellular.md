...
| `status` | [`?string(Status31)`](../../doc/models/status-31.md) | Optional | On a terminal that supports 3G or 4G connectivity, indicates the status of the primary SIM card in the terminal. | getStatus(): ?string | setStatus(?string status): void |
