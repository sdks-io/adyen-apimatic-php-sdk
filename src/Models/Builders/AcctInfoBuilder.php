...
use AdyenApIsLib\Models\AcctInfo;
use Core\Utils\CoreHelper;

/**
 * Builder for model AcctInfo
 *
 * @see AcctInfo
 */
class AcctInfoBuilder
{
    /**
     * @var AcctInfo
     */
    ...
    private function __construct(AcctInfo $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Acct Info Builder object.
     */
    public static function init(): self
    {
        return new self(new AcctInfo());
    }
    ...
    /**
     * Initializes a new Acct Info object.
     */
    public function build(): AcctInfo
    {
