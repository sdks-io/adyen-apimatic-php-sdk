...
class DeliveryAddressUsageIndicator
{
    ...
    private const _ALL_VALUES =
        [self::THISTRANSACTION, self::LESSTHAN30DAYS, self::FROM30TO60DAYS, self::MORETHAN60DAYS];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for DeliveryAddressUsageIndicator.");
    }
}
