...
class DeliveryTimeframe
{
    ...
    public const TWOORMOREDAYSSHIPPING = 'twoOrMoreDaysShipping';

    private const _ALL_VALUES =
        [self::ELECTRONICDELIVERY, self::SAMEDAYSHIPPING, self::OVERNIGHTSHIPPING, self::TWOORMOREDAYSSHIPPING];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for DeliveryTimeframe.");
    }
}
