 ...
 */
class File4 implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the File4 object to a human-readable string representation.
     *
     * @return string The string representation of the File4 object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify('File4', ['data' => $this->data, 'name' => $this->name]);
    }
