 ...
 */
class GenericPmWithTdiInfo1 implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the GenericPmWithTdiInfo1 object to a human-readable string representation.
     *
     * @return string The string representation of the GenericPmWithTdiInfo1 object.
     */
