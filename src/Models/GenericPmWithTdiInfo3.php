 ...
 */
class GenericPmWithTdiInfo3 implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the GenericPmWithTdiInfo3 object to a human-readable string representation.
     *
     * @return string The string representation of the GenericPmWithTdiInfo3 object.
     */
