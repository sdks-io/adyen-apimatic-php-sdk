 ...
 */
class GenericPmWithTdiInfo4 implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the GenericPmWithTdiInfo4 object to a human-readable string representation.
     *
     * @return string The string representation of the GenericPmWithTdiInfo4 object.
     */
