 ...
 */
class GenericPmWithTdiInfo6 implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the GenericPmWithTdiInfo6 object to a human-readable string representation.
     *
     * @return string The string representation of the GenericPmWithTdiInfo6 object.
     */
