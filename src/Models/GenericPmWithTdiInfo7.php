 ...
 */
class GenericPmWithTdiInfo7 implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the GenericPmWithTdiInfo7 object to a human-readable string representation.
     *
     * @return string The string representation of the GenericPmWithTdiInfo7 object.
     */
