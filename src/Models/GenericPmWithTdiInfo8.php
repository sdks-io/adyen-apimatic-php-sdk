 ...
 */
class GenericPmWithTdiInfo8 implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the GenericPmWithTdiInfo8 object to a human-readable string representation.
     *
     * @return string The string representation of the GenericPmWithTdiInfo8 object.
     */
