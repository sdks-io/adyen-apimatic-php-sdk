 ...
 */
class GenericPmWithTdiInfo9 implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the GenericPmWithTdiInfo9 object to a human-readable string representation.
     *
     * @return string The string representation of the GenericPmWithTdiInfo9 object.
     */
