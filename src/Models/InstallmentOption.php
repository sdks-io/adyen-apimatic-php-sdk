...
class InstallmentOption implements \JsonSerializable
{
    /**
     * @var int|null
     */
    ...
    /**
     * Converts the InstallmentOption object to a human-readable string representation.
     *
     * @return string The string representation of the InstallmentOption object.
     */
