...
class SdkEphemPubKey implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the SdkEphemPubKey object to a human-readable string representation.
     *
     * @return string The string representation of the SdkEphemPubKey object.
     */
