...
class TerminalReassignmentTarget implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the TerminalReassignmentTarget object to a human-readable string representation.
     *
     * @return string The string representation of the TerminalReassignmentTarget object.
     */
